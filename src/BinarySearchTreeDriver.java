...
public class BinarySearchTreeDriver {
	public static void main(String args[])throws IOException
	{
		...
		out.println("REVERSE ORDER\n"+tree.reverseOrder());//done
		out.println("Number of leaves: "+tree.getNumLeaves());//done
		out.println("Number of levels: "+tree.getNumLevels());//done
		out.println("The Tree width: "+tree.getWidth());//pending
		out.println("The Tree height: "+tree.getHeight());//pending
		out.println("Number of nodes: "+tree.getNumNodes());//done
		if(tree.isFull())
...
//		
		...
		out.println("Level order: "+tree.levelOrder2());
		numLines = input.nextInt();
		for(int i=0; i<numLines; i++)
		{
			String x = input.next();
